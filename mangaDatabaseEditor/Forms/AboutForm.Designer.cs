namespace mangaDatabaseEditor.Forms
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxDescription.Text = "Icons are Copyright © Yusuke Kamiyamane. All rights reserved. Licensed under a Cr" +
				 "eative Commons Attribution 3.0 license. http://p.yusukekamiyamane.com/";
			// 
			// okButton
			// 
