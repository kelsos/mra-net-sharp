...
{
    public partial class AddReadItemWindow : Form
    {
        private bool _displayAddedManga;

        /// <summary>
        /// Initializes a new instance of the <see cref="AddReadItemWindow"/> class.
        /// </summary>
        public AddReadItemWindow()
        {
            InitializeComponent();
        ...
        {
            using (NewReadItemDataWindow entryInfoForm = new NewReadItemDataWindow())
            {
