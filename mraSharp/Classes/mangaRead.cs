...
namespace mraSharp.Classes
{
    public class MangaRead
    {
        ...
        public MangaRead(string title, double? startingChapter, double? currentChapter, DateTime? lastRead,
        ...
        public MangaRead(double? startingChapter, double? currentChapter, DateTime? lastRead, string onlineURL,
